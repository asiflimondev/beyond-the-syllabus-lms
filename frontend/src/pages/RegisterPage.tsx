      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 bg-gradient-to-br from-white via-white to-orange-50/10">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
            ...
            {/* Role Selection */}
            <div>
              <label htmlFor="role" className="text-sm font-medium text-gray-700 block mb-1.5">
                Account Type
              </label>
              <select
                id="role"
                className="w-full px-4 py-3.5 bg-white border-2 border-gray-200 hover:border-gray-300 rounded-2xl text-gray-900 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500"
                {...register('role')}
              >
